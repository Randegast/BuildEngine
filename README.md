...
BuildEngine is a private project of mine. It's a lightweight java game engine.
...
Eventually I'm planning to combine the two in a single build. The source files here are from the BuildEngine GL version of the project.

<h3>BuildEngine JAVA</h3>
